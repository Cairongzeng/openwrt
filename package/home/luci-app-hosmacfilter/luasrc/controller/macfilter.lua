...
function index()
	...
	entry({"admin", "parental", "macfilter"}, alias("admin", "parental", "macfilter", "rules"),_("MAC Filter"), 84).dependent = true
	entry({"admin", "parental", "macfilter", "rules"}, cbi("macfilter/rules", {hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), _("Filter Rules"), 10).leaf=true
	entry({"admin", "parental", "macfilter", "whitelist"}, cbi("macfilter/whitelist", {hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), _("User Whitelist"), 20).leaf=true
	entry({"admin", "parental", "macfilter", "advance"}, cbi("macfilter/advance", {hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), _("Advanced Settings"), 30).leaf=true

	entry({"admin", "hos", "get_mac_filter_base"}, call("get_mac_filter_base"), nil).leaf = true
	entry({"admin", "hos", "set_mac_filter_base"}, call("set_mac_filter_base"), nil).leaf = true
	entry({"admin", "hos", "set_mac_filter_time"}, call("set_mac_filter_time"), nil).leaf = true
	entry({"admin", "hos", "get_mac_filter_time"}, call("get_mac_filter_time"), nil).leaf = true
	entry({"admin", "hos", "get_mac_filter_user"}, call("get_mac_filter_user"), nil).leaf = true
	entry({"admin", "hos", "set_mac_filter_user"}, call("set_mac_filter_user"), nil).leaf = true
	entry({"admin", "hos", "del_mac_filter_user"}, call("del_mac_filter_user"), nil).leaf = true
	entry({"admin", "hos", "add_mac_filter_user"}, call("add_mac_filter_user"), nil).leaf = true
	entry({"admin", "hos", "get_mf_status"}, call("get_mf_status"), nil).leaf = true
	entry({"admin", "hos", "get_mac_filter_whitelist"}, call("get_mac_filter_whitelist"), nil).leaf = true
	entry({"admin", "hos", "del_mac_filter_whitelist"}, call("del_mac_filter_whitelist"), nil).leaf = true
	entry({"admin", "hos", "add_mac_filter_whitelist"}, call("add_mac_filter_whitelist"), nil).leaf = true
...
function add_mac_filter_rule()
	...
	get_req_obj.data = {}
	local get_resp_obj = utl.ubus("hos", "common", get_req_obj)
