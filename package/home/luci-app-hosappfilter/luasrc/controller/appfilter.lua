...
function index()
	...
	entry({"admin", "parental"}, firstchild(), _("Parental Control"), 80).dependent = true
	entry({"admin", "parental", "appfilter"}, alias("admin", "parental", "appfilter", "rules"),_("App Filter"), 81).dependent = true
	entry({"admin", "parental", "appfilter", "rules"}, cbi("appfilter/rules", {hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), _("Filter Rules"), 10).leaf=true
	entry({"admin", "parental", "appfilter", "whitelist"}, cbi("appfilter/whitelist", {hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), _("User Whitelist"), 20).leaf=true
	entry({"admin", "parental", "appfilter", "advance"}, cbi("appfilter/advance", {hideapplybtn=true, hidesavebtn=true, hideresetbtn=true}), _("Advanced Settings"), 30).leaf=true
