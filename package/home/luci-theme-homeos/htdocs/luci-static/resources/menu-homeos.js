...
return baseclass.extend({
	menuIcons: {
		'hos_network': 'hos_network',
		'hos_wireless': 'hos_wireless',
		'hos_parental_control': 'hos_parental_control',
		'hos_advance': 'hos_advance',
		'hos_dashboard': 'hos_dashboard',
		'hos_internet_record': 'hos_internet_record',
		'hos_user': 'hos_user',
		'hos_wireless': 'hos_wireless',
	},
	defaultIcon: 'default',
	...
	renderCategoryNav() {
		...
		const basicLink = E('a', { 'href': L.url('admin', 'hos_dashboard') }, [_('Basic Settings')]);
			...
			if (currentNode.children && currentNode.children[pathSegment]) {
				...
				if (i === 0 && pathSegment === 'admin') {
					const homeItem = E('li', { 'class': 'home-item' }, [
						E('a', { 'href': '/cgi-bin/luci/admin/hos_dashboard', 'title': _('Home') }, [
